const a={slug:"apa-itu-Archeris",title:"Apa itu archeris.net?",excerpt:"Pengenalan menyeluruh tentang platform manajemen panahan terpadu pertama di Indonesia.",icon:"ph:info-bold",category:"platform",readTime:"3 menit",toc:[{id:"tentang",level:2,text:"Tentang archeris.net"},{id:"misi",level:2,text:"Misi Platform"},{id:"fitur-utama",level:2,text:"Fitur Utama"},{id:"untuk-siapa",level:2,text:"Untuk Siapa?"}],content:`
        ...
        `},n={slug:"registrasi-ulang",title:"Registrasi Ulang Akun Pemanah",excerpt:"Panduan memperbarui data registrasi akun pemanah: perubahan klub, kategori usia, dan verifikasi ulang identitas.",icon:"ph:arrows-clockwise-bold",category:"archer",readTime:"5 menit",toc:[{id:"kapan-perlu",level:2,text:"Kapan Perlu Registrasi Ulang?"},{id:"pindah-klub",level:2,text:"Pindah atau Ganti Klub"},{id:"update-kategori",level:2,text:"Perbarui Kategori & Divisi"},{id:"verifikasi-identitas",level:2,text:"Verifikasi Identitas Ulang"},{id:"langkah-langkah",level:2,text:"Langkah-Langkah Registrasi Ulang"},{id:"dampak",level:2,text:"Dampak pada Riwayat & Prestasi"}],content:`
                    ...
                    <ul>
                        ...
                        <li>Unggah dokumen dan tunggu proses tinjauan oleh tim archeris.net (1–2 hari kerja).</li>
        ...
        `},h={slug:"mobile-app-scoring",title:"Scoring via Aplikasi Mobile",excerpt:"Panduan lengkap wasit memakai mobile scoring dari login hingga sinkronisasi data.",icon:"ph:device-mobile-bold",category:"scoring",readTime:"6 menit",toc:[{id:"login-mobile",level:2,text:"Login Scorekeeper"},{id:"scan-qr",level:2,text:"Scan QR Assignment"},{id:"input-skor-mobile",level:2,text:"Input Skor"},{id:"sinkronisasi",level:2,text:"Sinkronisasi dan Troubleshooting"}],content:`
                ...
                `},y={slug:"manajemen-peserta",title:"Manajemen Peserta dan Bantalan",excerpt:"Panduan operasional menata peserta, memantau status, dan mengatur bantalan kualifikasi.",icon:"ph:table-bold",category:"event",readTime:"7 menit",toc:[{id:"lihat-peserta",level:2,text:"Melihat Daftar Peserta"},{id:"atur-bantalan",level:2,text:"Atur Penempatan Bantalan"},{id:"strategi-penempatan",level:2,text:"Strategi Penempatan"}],content:`
