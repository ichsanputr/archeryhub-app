...
async function capture() {
  ...
  // Scroll to Community Discussion
  await page.evaluate(() => window.scrollTo(0, 9500));
  await new Promise(r => setTimeout(r, 800));
  await page.screenshot({ path: 'C:/Users/HP/.gemini/antigravity/brain/e12e5a12-596d-4d0f-ada6-902db9bfe9df/scratch/article_discussion_bottom.png' });
  console.log('Saved discussion bottom');
