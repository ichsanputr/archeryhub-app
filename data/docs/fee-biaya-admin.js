export const fee_biaya_admin = {
    ...
    excerpt: 'Penjelasan tentang biaya platform, cara kerja listing produk, dan ketentuan promosi di Marketplace Archeryhub.id.',
    icon: 'ph:currency-circle-dollar-bold',
    category: 'marketplace',
    readTime: '3 menit',
    toc: [
        { id: 'gratis-berjualan', level: 2, text: 'Berjualan Gratis Tanpa Komisi' },
        { id: 'cara-transaksi', level: 2, text: 'Cara Transaksi: Langsung via WhatsApp' },
        { id: 'tanggung-jawab-harga', level: 2, text: 'Tanggung Jawab Harga & Negosiasi' },
        { id: 'promosi-berbayar', level: 2, text: 'Promosi & Fitur Berbayar (Opsional)' },
        { id: 'kebijakan-konten', level: 2, text: 'Kebijakan Konten Produk' },
    ],
    content: `
