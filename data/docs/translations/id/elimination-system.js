export const elimination_system = {
  slug: "elimination-system",
  title: "Sistem Pertandingan Eliminasi",
  excerpt: "Bracket eliminasi, mekanisme tie, dan additional end pada mode scoring pertandingan.",
  icon: "ph:git-branch-bold",
  category: "scoring",
  readTime: "8 menit",
  toc: [
    { id: "bracket", level: 2, text: "Membuat Bracket" },
    { id: "generate-otomatis", level: 2, text: "Generate Otomatis" },
    { id: "skor-set", level: 2, text: "Sistem Skor Set" },
    { id: "tie-mechanism", level: 2, text: "Mekanisme Tie (Seri)" },
    { id: "additional-end", level: 2, text: "Additional End di Dashboard" }
  ],
  content: `
