export const subscription_plans = {
  ...
  title: "Sistem & Paket Berlangganan",
  excerpt: "Informasi lengkap mengenai pilihan paket, fitur eksklusif, serta panduan tata cara berlangganan bagi Organisasi di archeris.net.",
  icon: "ph:crown-bold",
