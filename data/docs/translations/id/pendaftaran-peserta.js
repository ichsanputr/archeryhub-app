export const pendaftaran_peserta = {
    slug: 'pendaftaran-peserta', title: 'Pendaftaran Peserta ke Event', excerpt: 'Panduan pendaftaran individu, validasi data, and status pembayaran peserta.', icon: 'ph:clipboard-text-bold', category: 'event', readTime: '5 menit',
    toc: [
