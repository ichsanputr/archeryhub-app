export const creating_events = {
  slug: "creating-events",
  title: "Membuat dan Mempublish Event",
  excerpt: "Panduan lengkap merancang event dari draft, konfigurasi kategori, hingga rilis publik.",
  icon: "ph:plus-square-bold",
  category: "event",
  readTime: "9 menit",
  toc: [
