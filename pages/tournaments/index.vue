...
const COUNTRY_FLAG_ICONS = {
    ...
    'idn': 'circle-flags:id',
    'id': 'circle-flags:id',
    'croatia': 'circle-flags:hr',
    'cro': 'circle-flags:hr',
    'hrv': 'circle-flags:hr',
    'hr': 'circle-flags:hr',
    'ireland': 'circle-flags:ie',
    'irl': 'circle-flags:ie',
    'ie': 'circle-flags:ie',
    ...
    'gbr': 'circle-flags:gb',
    'gb': 'circle-flags:gb',
    'england': 'circle-flags:gb',
    'scotland': 'circle-flags:gb',
    'wales': 'circle-flags:gb',
    'united states': 'circle-flags:us',
    'united states of america': 'circle-flags:us',
    'usa': 'circle-flags:us',
    'us': 'circle-flags:us',
    'turkey': 'circle-flags:tr',
    'turkiye': 'circle-flags:tr',
    'tur': 'circle-flags:tr',
    'tr': 'circle-flags:tr',
    ...
    'lva': 'circle-flags:lv',
    'lv': 'circle-flags:lv',
    'lithuania': 'circle-flags:lt',
    'ltu': 'circle-flags:lt',
    'lt': 'circle-flags:lt',
    'estonia': 'circle-flags:ee',
    'est': 'circle-flags:ee',
    'ee': 'circle-flags:ee',
    ...
    'chn': 'circle-flags:cn',
    'cn': 'circle-flags:cn',
    'chinese taipei': 'circle-flags:tw',
    'taiwan': 'circle-flags:tw',
    'tpe': 'circle-flags:tw',
    'tw': 'circle-flags:tw',
    ...
    'aut': 'circle-flags:at',
    'at': 'circle-flags:at',
    'sweden': 'circle-flags:se',
    'swe': 'circle-flags:se',
    'se': 'circle-flags:se',
    'norway': 'circle-flags:no',
    'nor': 'circle-flags:no',
    'no': 'circle-flags:no',
    'denmark': 'circle-flags:dk',
    'den': 'circle-flags:dk',
    'dnk': 'circle-flags:dk',
    'dk': 'circle-flags:dk',
    'finland': 'circle-flags:fi',
    'fin': 'circle-flags:fi',
    'fi': 'circle-flags:fi',
    'czech republic': 'circle-flags:cz',
    'czechia': 'circle-flags:cz',
    'cze': 'circle-flags:cz',
    'cz': 'circle-flags:cz',
    'slovakia': 'circle-flags:sk',
    'svk': 'circle-flags:sk',
    'sk': 'circle-flags:sk',
    'hungary': 'circle-flags:hu',
    'hun': 'circle-flags:hu',
    'hu': 'circle-flags:hu',
    'romania': 'circle-flags:ro',
    'rou': 'circle-flags:ro',
    'rom': 'circle-flags:ro',
    'ro': 'circle-flags:ro',
    'bulgaria': 'circle-flags:bg',
    'bul': 'circle-flags:bg',
    'bg': 'circle-flags:bg',
    'greece': 'circle-flags:gr',
    'gre': 'circle-flags:gr',
    'grc': 'circle-flags:gr',
    'gr': 'circle-flags:gr',
    'cyprus': 'circle-flags:cy',
    'cyp': 'circle-flags:cy',
    'cy': 'circle-flags:cy',
    'slovenia': 'circle-flags:si',
    'slo': 'circle-flags:si',
    'svn': 'circle-flags:si',
    'si': 'circle-flags:si',
    'serbia': 'circle-flags:rs',
    'srb': 'circle-flags:rs',
    'rs': 'circle-flags:rs',
    'bosnia and herzegovina': 'circle-flags:ba',
    'bosnia': 'circle-flags:ba',
    'bih': 'circle-flags:ba',
    'ba': 'circle-flags:ba',
    'montenegro': 'circle-flags:me',
    'mne': 'circle-flags:me',
    'me': 'circle-flags:me',
    'north macedonia': 'circle-flags:mk',
    'macedonia': 'circle-flags:mk',
    'mkd': 'circle-flags:mk',
    'mk': 'circle-flags:mk',
    'albania': 'circle-flags:al',
    'alb': 'circle-flags:al',
    'al': 'circle-flags:al',
    ...
    'brasil': 'circle-flags:br',
    'bra': 'circle-flags:br',
    'br': 'circle-flags:br',
    'argentina': 'circle-flags:ar',
    'arg': 'circle-flags:ar',
    'ar': 'circle-flags:ar',
    'chile': 'circle-flags:cl',
    'chi': 'circle-flags:cl',
    'chl': 'circle-flags:cl',
    'cl': 'circle-flags:cl',
    'colombia': 'circle-flags:co',
    'col': 'circle-flags:co',
    'co': 'circle-flags:co',
    'peru': 'circle-flags:pe',
    'per': 'circle-flags:pe',
    'pe': 'circle-flags:pe',
    'egypt': 'circle-flags:eg',
    'egy': 'circle-flags:eg',
    'eg': 'circle-flags:eg',
    ...
    'qat': 'circle-flags:qa',
    'qa': 'circle-flags:qa',
    'iran': 'circle-flags:ir',
    'iri': 'circle-flags:ir',
    'irn': 'circle-flags:ir',
    'ir': 'circle-flags:ir',
    'iraq': 'circle-flags:iq',
    'irq': 'circle-flags:iq',
    'iq': 'circle-flags:iq',
    'kazakhstan': 'circle-flags:kz',
    'kaz': 'circle-flags:kz',
    'kz': 'circle-flags:kz',
    'uzbekistan': 'circle-flags:uz',
    'uzb': 'circle-flags:uz',
    'uz': 'circle-flags:uz',
    'ukraine': 'circle-flags:ua',
    'ukr': 'circle-flags:ua',
    'ua': 'circle-flags:ua',
    'luxembourg': 'circle-flags:lu',
    'lux': 'circle-flags:lu',
    'lu': 'circle-flags:lu',
    'iceland': 'circle-flags:is',
    'isl': 'circle-flags:is',
    'is': 'circle-flags:is',
    'malta': 'circle-flags:mt',
    'mlt': 'circle-flags:mt',
    'mt': 'circle-flags:mt',
    'san marino': 'circle-flags:sm',
    'smr': 'circle-flags:sm',
    'sm': 'circle-flags:sm',
    'monaco': 'circle-flags:mc',
    'mon': 'circle-flags:mc',
    'mc': 'circle-flags:mc',
    'liechtenstein': 'circle-flags:li',
    'lie': 'circle-flags:li',
    'li': 'circle-flags:li',
    'andorra': 'circle-flags:ad',
    'and': 'circle-flags:ad',
    'ad': 'circle-flags:ad',
    'georgia': 'circle-flags:ge',
    'geo': 'circle-flags:ge',
    'ge': 'circle-flags:ge',
    'armenia': 'circle-flags:am',
    'arm': 'circle-flags:am',
    'am': 'circle-flags:am',
    'azerbaijan': 'circle-flags:az',
    'aze': 'circle-flags:az',
    'az': 'circle-flags:az',
    'israel': 'circle-flags:il',
    'isr': 'circle-flags:il',
    'il': 'circle-flags:il',
    'morocco': 'circle-flags:ma',
    'mar': 'circle-flags:ma',
    'ma': 'circle-flags:ma',
    'algeria': 'circle-flags:dz',
    'alg': 'circle-flags:dz',
    'dza': 'circle-flags:dz',
    'dz': 'circle-flags:dz',
    'tunisia': 'circle-flags:tn',
    'tun': 'circle-flags:tn',
    'tn': 'circle-flags:tn',
    ...
    'lka': 'circle-flags:lk',
    'lk': 'circle-flags:lk',
    'nepal': 'circle-flags:np',
    'nep': 'circle-flags:np',
    'npl': 'circle-flags:np',
    'np': 'circle-flags:np',
    'myanmar': 'circle-flags:mm',
    'mya': 'circle-flags:mm',
    'mmr': 'circle-flags:mm',
    'mm': 'circle-flags:mm',
    'cambodia': 'circle-flags:kh',
    'cam': 'circle-flags:kh',
    'khm': 'circle-flags:kh',
    'kh': 'circle-flags:kh',
    'laos': 'circle-flags:la',
    'lao': 'circle-flags:la',
    'la': 'circle-flags:la',
    'brunei': 'circle-flags:bn',
    'bru': 'circle-flags:bn',
    'brn': 'circle-flags:bn',
    'bn': 'circle-flags:bn',
    'mongolia': 'circle-flags:mn',
    'mgl': 'circle-flags:mn',
    'mn': 'circle-flags:mn',
    'puerto rico': 'circle-flags:pr',
    'pur': 'circle-flags:pr',
    'pri': 'circle-flags:pr',
    'pr': 'circle-flags:pr',
    'cuba': 'circle-flags:cu',
    'cub': 'circle-flags:cu',
    'cu': 'circle-flags:cu',
    'guatemala': 'circle-flags:gt',
    'gua': 'circle-flags:gt',
    'gtm': 'circle-flags:gt',
    'gt': 'circle-flags:gt',
    'el salvador': 'circle-flags:sv',
    'esa': 'circle-flags:sv',
    'slv': 'circle-flags:sv',
    'sv': 'circle-flags:sv',
    'costa rica': 'circle-flags:cr',
    'crc': 'circle-flags:cr',
    'cri': 'circle-flags:cr',
    'cr': 'circle-flags:cr',
    'panama': 'circle-flags:pa',
    'pan': 'circle-flags:pa',
    'pa': 'circle-flags:pa',
    'dominican republic': 'circle-flags:do',
    'dom': 'circle-flags:do',
    'do': 'circle-flags:do',
    'venezuela': 'circle-flags:ve',
    'ven': 'circle-flags:ve',
    've': 'circle-flags:ve',
    'uruguay': 'circle-flags:uy',
    'uru': 'circle-flags:uy',
    'ury': 'circle-flags:uy',
    'uy': 'circle-flags:uy',
    'paraguay': 'circle-flags:py',
    'par': 'circle-flags:py',
    'pry': 'circle-flags:py',
    'py': 'circle-flags:py',
    'bolivia': 'circle-flags:bo',
    'bol': 'circle-flags:bo',
    'bo': 'circle-flags:bo',
    'trinidad and tobago': 'circle-flags:tt',
    'tto': 'circle-flags:tt',
    'tt': 'circle-flags:tt',
    'jamaica': 'circle-flags:jm',
    'jam': 'circle-flags:jm',
    'jm': 'circle-flags:jm'
}

function getCountryFlagIcon(countryName) {
    if (!countryName) return 'ph:globe-hemisphere-west'
    const key = String(countryName).toLowerCase().trim()
    if (COUNTRY_FLAG_ICONS[key]) return COUNTRY_FLAG_ICONS[key]
    if (key.length === 2) return `circle-flags:${key}`
