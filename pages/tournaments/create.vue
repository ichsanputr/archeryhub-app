  ...
  <div class="min-h-screen pb-20">
    ...
    <div class="card">
      <form @submit.prevent="handleSubmit" class="flex flex-col gap-8">
        ...
        <div class="flex flex-col gap-6">
          ...
          <div class="grid grid-cols-1 gap-6">
            <label class="flex flex-col gap-2">
              ...
              <input v-model="form.name" class="input" placeholder="e.g., National Indoor Championship 2024" type="text"
                required />
            </label>
            ...
            <label class="flex flex-col gap-2">
              ...
              <div class="relative">
                <span
                  class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-brand-gold pointer-events-none">
                  location_on
                </span>
                <input v-model="form.venue" class="input pl-12 pr-4" placeholder="Enter venue name or address"
                  type="text" />
              </div>
            </label>
          </div>
        ...
        <div class="flex flex-col gap-6 pt-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <label class="flex flex-col gap-2">
              ...
              <input v-model="form.startDate" class="input [color-scheme:dark]" type="datetime-local" required />
            </label>

            <label class="flex flex-col gap-2">
              <span class="text-white text-base font-medium">End Date & Time</span>
              <input v-model="form.endDate" class="input [color-scheme:dark]" type="datetime-local" required />
            </label>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 gap-6">
            <label class="flex flex-col gap-2">
              ...
              <textarea v-model="form.description"
                ...
                placeholder="Describe the event format, rules, and any special instructions for archers..."></textarea>
            ...
            <div class="flex flex-col gap-2">
              ...
              <div
                class="border-2 border-dashed border-brand-border rounded-xl bg-brand-surface/50 p-8 flex flex-col items-center justify-center text-center gap-4 hover:bg-brand-surface hover:border-primary/50 transition-all cursor-pointer group">
                <div
                  class="size-16 rounded-full bg-brand-surface flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        <!-- Action Bar -->
        <div
          class="flex flex-col-reverse md:flex-row items-center justify-end gap-4 pt-8 border-t border-brand-border mt-4">
