...
const archers = [
    ...
    { id: 2, name: 'Diananda Choirunisa', club: 'Jatim Archery Hub', division: 'Recurve Women', category: '70m Public', target: '14B', status: 'verified', image: 'https://i.pravatar.cc/150?u=diana' },
