    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
      <div>
        <div class="flex flex-wrap gap-2 mb-2">
          ...
          <NuxtLink :to="`/tournaments/${tournamentId}`" class="text-brand-gold text-sm font-medium hover:text-primary">
            {{ tournamentName }}
          </NuxtLink>
          <span class="text-gray-600 text-sm font-medium">/</span>
      ...
      <div class="lg:col-span-4">
        <div class="sticky top-6 flex flex-col gap-6">
          ...
          <div class="flex flex-col gap-3">
            ...
            <NuxtLink :to="`/tournaments/${tournamentId}/create`" class="btn-secondary py-3 text-center">
              Back to Details
            </NuxtLink>
          </div>
        </div>
