<template>
    <div v-if="article" class="min-h-screen bg-[#f8fafc] relative">
        ...
        <section class="pt-12 pb-16">
            <div class="container mx-auto px-4 max-w-7xl">
                <div class="flex flex-wrap items-center gap-3 mb-8">
                    <span class="bg-primary text-navy text-[10px] font-black px-4 py-1.5 rounded-full tracking-widest ">
                        {{ article.category }}
                    </span>
                            ...
                            <NuxtLink to="/about-us"
                                ...
                                <div class="flex items-center gap-6">
                                    <img :src="article.author.avatar"
                                        class="w-16 h-16 rounded-[20px] bg-slate-100 border-2 border-primary/20 group-hover:border-primary transition-all" />
                                    <div>
                                        <div
                                ...
                                <div class="hidden md:flex gap-3">
                                    <div
                                        class="size-11 rounded-2xl bg-slate-50 border border-navy/5 flex items-center justify-center group-hover:bg-navy group-hover:text-white transition-all">
                            ...
                            <section class="mt-16 pt-16 border-t border-navy/5">
                                ...
                                <div
                                    ...
                                    <form @submit.prevent="submitComment" class="space-y-6">
                                        ...
                                        <div v-else
                                            class="flex items-center gap-4 mb-6 p-4 bg-slate-50 rounded-2xl border border-navy/5">
                                            <div
                                    ...
                                    <div v-else v-for="comment in comments" :key="comment.id" class="group">
                                        <div class="flex gap-4 sm:gap-6 items-start">
                                            <div class="flex-shrink-0">
                                                <div
                                                    class="w-12 h-12 rounded-2xl bg-white border border-navy/5 flex items-center justify-center text-navy font-black text-xl group-hover:bg-primary group-hover:text-white group-hover:border-primary transition-all duration-500 shadow-sm">
                                            ...
                                            <div class="flex-grow pt-1">
                                                ...
                                                <div
                                                    class="text-navy/70 text-lg leading-relaxed font-medium bg-white p-7 rounded-3xl rounded-tl-none border border-navy/5 group-hover:border-primary/20 transition-all shadow-sm">
                                                    {{ comment.content }}
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="bg-white rounded-[32px] border border-navy/5 p-8 shadow-sm">
                            ...
                            <div class="flex flex-col gap-8">
                                <NuxtLink v-for="item in popularArticles" :key="item.slug" :to="`/blog/${item.slug}`"
                                    ...
                                    <div
                                        class="w-20 h-20 rounded-2xl overflow-hidden flex-shrink-0 bg-slate-100 border border-navy/5">
                                        <img :src="item.image"
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <div class="text-navy/20 text-[8px] font-bold ">{{ item.date }}</div>
                                    </div>
                                </NuxtLink>
                            </div>
        ...
        <section class="bg-slate-50 py-32 border-t border-navy/5 overflow-hidden relative">
            <div
                class="absolute top-0 right-0 w-1/3 h-full bg-primary/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2">
            </div>
            <div class="container mx-auto px-4 max-w-7xl">
