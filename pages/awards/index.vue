          ...
          <tbody class="divide-y divide-[#4a4421]">
            ...
            >
              ...
              <td class="px-6 py-4 text-center">
                <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-yellow-500/20 text-yellow-500 font-bold">
                  {{ m.gold }}
                </span>
              </td>
              <td class="px-6 py-4 text-center">
                <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-300/20 text-gray-300 font-bold">
                  {{ m.silver }}
                </span>
              </td>
              <td class="px-6 py-4 text-center">
                <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-amber-700/20 text-amber-700 font-bold">
                  {{ m.bronze }}
                </span>
              </td>
      ...
      <div class="bg-[#2E2B1B] rounded-xl border border-[#4a4421] overflow-hidden">
        <div class="px-6 py-4 border-b border-[#4a4421] bg-[#4a4421]/20 flex items-center justify-between">
          ...
          <div class="flex gap-2">
            <button 
              v-for="type in ['all', 'gold', 'silver', 'bronze']"
              :key="type"
              @click="awardFilter = type"
              class="px-3 py-1 rounded text-xs font-medium transition-colors"
              :class="awardFilter === type 
          ...
          <form @submit.prevent="autoAward" class="p-6 space-y-4">
            ...
            <div class="bg-[#4a4421]/30 rounded-lg p-4">
              <p class="text-[#ccc38e] text-sm">
                This will automatically create Gold, Silver, and Bronze awards for the selected event based on the final match results.
              </p>
            </div>
