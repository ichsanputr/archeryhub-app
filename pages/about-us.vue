        ...
        <section class="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-navy">
            ...
            <div class="container mx-auto px-4 max-w-7xl relative z-10 text-center">
                ...
                <p class="text-white/60 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
                    Kami hadir untuk mendigitalisasi setiap tarikan busur, memastikan setiap skor tercatat dengan
                    presisi,
                    ...
                    <div class="p-12 bg-navy rounded-[40px] relative group overflow-hidden text-white">
                        ...
                        <ul class="space-y-6">
                            <li class="flex gap-4">
                                ...
                                <p class="text-white/60 font-medium">Menyediakan sistem scoring real-time yang canggih
                                    dan mudah digunakan.</p>
                            </li>
                            <li class="flex gap-4">
                                <div class="w-2 h-2 rounded-full bg-primary mt-3 flex-shrink-0"></div>
                                <p class="text-white/60 font-medium">Membangun database atlet nasional yang terintegrasi
                                    dan prestisius.</p>
                            </li>
                            <li class="flex gap-4">
                                <div class="w-2 h-2 rounded-full bg-primary mt-3 flex-shrink-0"></div>
                                <p class="text-white/60 font-medium">Mendukung penyelenggara turnamen dengan alat
                                    manajemen yang profesional.</p>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                    ...
                    <div class="lg:col-span-5">
                        <h2 class="text-4xl md:text-5xl font-black text-navy leading-tight tracking-tighter mb-8 ">
                            Berawal dari <br /> <span class="text-primary italic">Garasi Kecil.</span></h2>
                        <div class="space-y-6 text-navy/50 text-lg leading-relaxed font-medium">
                            <p>Archeris dimulai dengan visi sederhana untuk memecahkan masalah manualnya pencatatan skor
                                di lapangan panahan tradisional.</p>
                            <p>Kini, kami telah berkembang menjadi ekosistem lengkap yang melayani ribuan atlet dan
                                ratusan organisasi panahan di seluruh Indonesia.</p>
                            <p>Setiap baris kode yang kami tulis didedikasikan untuk presisi, transparansi, dan kemajuan
                                olahraga panahan nasional.</p>
                        </div>
                    </div>
                </div>
            </div>
