        ...
        <div v-else class="space-y-8">
            ...
            <div v-if="activeTab === 'overview'" class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-1 space-y-6">
                    <div
                        class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm group hover:border-primary transition-all">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="h-12 w-12 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-colors">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="h-12 w-12 rounded-xl bg-orange-50 text-orange-600 flex items-center justify-center group-hover:bg-orange-600 group-hover:text-white transition-colors">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="h-12 w-12 rounded-xl bg-green-50 text-green-600 flex items-center justify-center group-hover:bg-green-600 group-hover:text-white transition-colors">
                ...
                <div class="lg:col-span-3 space-y-8">
                    <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
                        <div
                            class="px-8 py-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gray-50/50">
                            <div>
                            ...
                            <div class="flex gap-4">
                                <div
                                    ...
                                    <span class="w-2 h-2 rounded-full bg-primary animate-pulse"></span> Scoring
                                </div>
                                <div
                                    class="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-gray-400">
                        ...
                        <div class="p-8">
                            <div class="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10 gap-3">
                                <button v-for="i in maxTargets" :key="i"
                                    ...
                                    :class="groupedTargets[i] ? 'border-primary/50 bg-primary/5' : 'border-gray-100 bg-gray-50/30 italic'">
                                    <span
