    ...
    <div class="flex flex-col gap-8">
        ...
        <div class="relative overflow-hidden rounded-3xl border border-primary/20 bg-navy text-white shadow-sm">
            ...
            <div class="relative p-6 sm:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <BaseButton to="/dashboard/club/news/create" variant="primary" icon="ph:plus-bold"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div v-for="item in filteredNews" :key="item.id"
                ...
                <div class="px-6 py-4 bg-gray-50/50 border-t border-gray-100 flex gap-2">
                    <NuxtLink :to="`/dashboard/club/news/${item.slug}`" class="flex-1">
                        <BaseButton variant="white" size="sm" icon="ph:eye" block class="!h-9">
                            Lihat
                        </BaseButton>
                    </NuxtLink>
                    <NuxtLink :to="`/dashboard/club/news/${item.slug}/edit`" class="flex-1">
