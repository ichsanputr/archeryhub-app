                    ...
                    <div class="p-5 flex flex-col gap-4 flex-1">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="font-black text-gray-800 text-sm truncate">{{ sub.archer_name }}</div>
                                <div class="text-xs text-gray-400 truncate">{{ sub.archer_email }}</div>
                            </div>
                                ...
                                <template v-else>
                                    ...
                                    <div class="px-6 pt-3 pb-6">
                                        ...
                                        <div v-for="p in history.payments" :key="p.uuid"
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="font-bold text-sm text-gray-800">{{ formatCurrency(p.amount)
                                                    }}</div>
                                                <div class="text-xs text-gray-400">{{ p.payment_method }} · {{
                                                    formatDate(p.paid_at) }}</div>
                                                <div v-if="p.payment_note" class="text-xs text-gray-400 truncate">{{
                                                    p.payment_note }}</div>
                                            </div>
                                            <div
