<template>
  <div class="space-y-8">
    ...
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-xl sm:text-2xl font-black text-navy-dark">{{ t('dashboard.reports.attendance_title') }}</h1>
        <p class="text-gray-500 text-xs font-bold leading-none mt-1">Track Checked-in vs Registered Participants Status.</p>
      </div>
    </div>
