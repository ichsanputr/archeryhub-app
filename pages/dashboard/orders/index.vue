<template>
  <div class="space-y-6">
    ...
    <div class="flex flex-col gap-4">
      <Breadcrumbs :items="breadcrumbItems" current="Pesanan" />

      <div class="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 class="text-2xl md:text-3xl font-black text-navy tracking-tight">Pesanan Masuk</h1>
          <p class="text-gray-500 mt-1 font-medium text-sm md:text-base">Kelola dan pantau transaksi penjualan produk
            Anda</p>
        </div>
        <div class="flex gap-3">
          <BaseButton variant="outline" size="sm" icon="ph:download-simple" class="h-9 md:h-10">
      ...
      <div class="p-6 border-b border-gray-50 space-y-4">
        <div class="flex flex-wrap items-center justify-between gap-4">
          ...
          <div class="relative w-full md:w-64">
            ...
            <input v-model="searchQuery" type="text" placeholder="Cari No. Pesanan atau Pembeli..."
...
useHead({
  title: 'Pesanan Masuk - ArcheryHub Dashboard'
})
