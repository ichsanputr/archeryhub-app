...
<template>
    <div class="flex flex-col gap-6 md:gap-8 pb-16">
        ...
        <div v-else class="py-16 text-center bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
            ...
            <div>
                <NuxtLink to="/dashboard/archer/tournaments" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-900 text-white text-xs font-bold hover:bg-slate-800 transition-colors">
