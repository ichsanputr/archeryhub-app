  ...
  <div class="space-y-8">
    ...
    <div class="flex flex-col gap-6">
      <nav class="flex flex-wrap gap-2 items-center">
        ...
        <NuxtLink to="/dashboard/archer/tournaments"
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-6 md:p-10 shadow-sm">
      <form @submit.prevent="handleSubmit" class="flex flex-col gap-10">
          ...
          <FormSection icon="ant-design:schedule-outlined" :title="t('event_create.schedule_pricing')">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <BaseCurrencyInput
                ...
                :label="t('event_create.entry_fee')"
                prefix="Rp"
                placeholder="350000"
        ...
        <div
          ...
          <BaseButton to="/dashboard/archer/tournaments" variant="ghost" class="px-8 whitespace-nowrap">
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (result?.id || result?.uuid) {
        ...
        try {
          await Promise.all(
            form.paymentMethods
              ...
              .map(method =>
                post(`/tournaments/${eventId}/payment-methods`, {
      ...
      router.push('/dashboard/archer/tournaments')
    }
  } catch (error) {
