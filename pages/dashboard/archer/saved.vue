        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 max-w-md mx-auto">
          <div class="flex flex-col items-center gap-6">
            ...
            <div class="flex flex-col gap-3 w-full">
              ...
              <BaseButton to="/dashboard/archer/events" variant="outline" block icon="ph:magnifying-glass">
                Cari Event
              </BaseButton>
            </div>
          </div>
      ...
      <div v-else-if="savedProblems.length === 0" class="text-center py-16">
        <div class="flex flex-col items-center gap-6">
          ...
          <div class="flex flex-col gap-3 w-full max-w-md">
            <BaseButton to="/dashboard/archer/events" variant="gold" block icon="ph:magnifying-glass" size="lg">
              Cari Event
            </BaseButton>
        ...
        <div v-else class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div v-for="problem in savedProblems" :key="problem.id"
            ...
            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
              <BaseButton :to="`/dashboard/archer/events/${problem.id}`" variant="primary" size="sm" icon="ph:info">
                Detail Event
              </BaseButton>
        ...
        <div v-if="user && savedProblems.length === 0 && !loading" class="text-center py-16">
          <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 max-w-md mx-auto">
            <div class="flex flex-col items-center gap-6">
              ...
              <div class="flex flex-col gap-3 w-full">
                <BaseButton to="/dashboard/archer/events" variant="gold" block icon="ph:magnifying-glass">
                  Cari Event
                </BaseButton>
