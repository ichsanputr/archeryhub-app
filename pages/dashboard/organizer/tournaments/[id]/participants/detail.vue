            ...
            <div class="relative p-6 sm:p-8">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                    ...
                    <div class="flex items-center gap-3 shrink-0">
                        <BaseButton v-if="archerId" :to="`/dashboard/organizer/tournaments/${eventId}/participants/edit?archer_id=${archerId}`" variant="primary" icon="ph:pencil-simple-bold" class="h-10 px-5 text-xs font-black shadow-md shadow-primary/20">
