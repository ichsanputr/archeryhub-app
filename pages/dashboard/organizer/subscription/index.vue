...
const userType = computed(() => user.value?.user_type || user.value?.role || 'organizer')
...
const roleContent = computed(() => {
    return {
        ...
        promoDesc: t('subscription.promoDesc', 'Daftarkan penyelenggara Anda sekarang and dapatkan paket Standard secara gratis selama 3 bulan pertama.'),
