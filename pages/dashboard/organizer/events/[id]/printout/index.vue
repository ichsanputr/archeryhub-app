    ...
    items: [
      {
        ...
        to: `/dashboard/organizer/events/${eventId}/printout/qualification`
      },
      {
        id: 'elimination',
        ...
        to: `/dashboard/organizer/events/${eventId}/printout/elimination`
      }
    ]
  },
  {
        ...
        subActions: [
          {
            ...
            action: () => downloadPdfFile(`/events/${eventId}/participants/printout?type=alphabetical`, `${eventName.value || 'event'}-peserta-abjad.pdf`, 'participants_alphabetical')
          },
          {
            key: 'participants_club',
            label: t('event_printout.participants.by_club', 'Berdasarkan Klub / Kontingen'),
            action: () => downloadPdfFile(`/events/${eventId}/participants/printout?type=by-club`, `${eventName.value || 'event'}-peserta-klub.pdf`, 'participants_club')
          },
          {
            key: 'participants_category',
            label: t('event_printout.participants.by_category', 'Berdasarkan Kategori Lomba'),
            action: () => downloadPdfFile(`/events/${eventId}/participants/printout?type=by-category`, `${eventName.value || 'event'}-peserta-kategori.pdf`, 'participants_category')
          }
        ]
      },
      {
        ...
        type: 'direct',
        action: () => downloadPdfFile(`/events/${eventId}/qualification/start-list/printout`, `${eventName.value || 'event'}-start-list.pdf`, 'start_list')
      },
      {
        id: 'target_labels',
        ...
        icon: 'ph:tag-bold',
        type: 'direct',
        action: () => downloadPdfFile(`/events/${eventId}/targets/labels/printout`, `${eventName.value || 'event'}-label-target.pdf`, 'target_labels')
      }
    ]
  },
  {
        ...
        subActions: [
          {
            ...
            action: () => downloadPdfFile(`/events/${eventId}/participants/statistics-classes`, `${eventName.value || 'event'}-statistik-kelas.pdf`, 'stats_classes')
          },
          {
            key: 'stats_clubs',
            label: t('event_printout.statistics.clubs_title', 'Statistik Klub & Kontingen'),
            action: () => downloadPdfFile(`/events/${eventId}/participants/statistics-clubs`, `${eventName.value || 'event'}-statistik-klub.pdf`, 'stats_clubs')
          }
        ]
      },
      {
        ...
        type: 'direct',
        action: () => downloadPdfFile(`/events/${eventId}/qualification/results/printout`, `${eventName.value || 'event'}-hasil-kualifikasi.pdf`, 'qual_results')
      },
      {
        id: 'medals',
        ...
        icon: 'ph:medal-bold',
        type: 'direct',
        action: () => downloadPdfFile(`/events/${eventId}/results/medals/printout`, `${eventName.value || 'event'}-klasemen-medali.pdf`, 'medals')
      }
    ]
  }
])
