        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                <div class="flex items-center gap-2 text-sm text-gray-400 mb-2 font-bold tracking-tight">
                    ...
                    <NuxtLink to="/dashboard/root/news" class="hover:text-primary transition-colors">Berita
                    </NuxtLink>
                    <Icon icon="ph:caret-right-bold" class="text-[12px]" />
            ...
            <div class="flex items-center gap-3">
                <NuxtLink :to="`/dashboard/root/news/${route.params.slug}/edit`">
...
import DeleteConfirmationModal from '~/components/common/AppDialog.vue'
