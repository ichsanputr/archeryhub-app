    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <section class="container mx-auto px-4 max-w-7xl -mt-8 relative z-20">
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 flex flex-col md:flex-row gap-4">
                <div class="flex-1">
                    <BaseInput v-model="searchQuery" placeholder="Cari nama organisasi..." icon="ph:magnifying-glass" />
                </div>
        ...
        <section class="container mx-auto px-4 max-w-7xl py-16">
            ...
            <div v-else-if="organizations.length === 0" class="text-center py-20">
                ...
                <h3 class="text-xl font-bold text-gray-500">Tidak ada organisasi ditemukan</h3>
                <p class="text-gray-400 mt-2">Coba gunakan kata kunci lain</p>
            </div>

            <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <NuxtLink v-for="org in organizations" :key="org.id" :to="`/organization/${org.username || org.id}`"
                    ...
                    <div class="p-6 -mt-10 relative">
                        ...
                        <div class="flex items-start justify-between gap-2 mb-3">
                            ...
                            <span v-if="org.verification_status === 'verified'"
                                class="flex items-center gap-1 px-2 py-1 bg-blue-50 text-blue-600 text-[10px] font-black rounded-full uppercase">
