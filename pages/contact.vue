      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-3xl font-display">
          ...
          <p class="text-slate-300 text-sm md:text-lg leading-relaxed max-w-2xl">
            Have questions about the platform? Whether you are an athlete or an event organizer, we are here to help you hit your target.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        <div class="lg:col-span-8">
          <div
            ...
            <h2 class="text-lg md:text-2xl font-black text-navy dark:text-white mb-6">Send us a message</h2>
            <form class="space-y-6" @submit.prevent="handleSubmit">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label class="block text-xs font-bold text-slate-500  tracking-wider mb-2">Your Name</label>
                ...
                <div>
                  <label class="block text-xs font-bold text-slate-500  tracking-wider mb-2">Email Address</label>
        ...
        <div class="lg:col-span-4 space-y-6">
          <div class="bg-navy rounded-2xl shadow-sm p-8 relative overflow-hidden text-white">
            ...
            <h3 class="font-black text-lg md:text-xl mb-6 relative z-10">Contact Information</h3>
           ...
           <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
             ...
             <p class="text-sm text-slate-500 mb-3">Looking for frequently asked questions or technical guides? Visit our Documentation for instant answers.</p>
             <NuxtLink to="/docs"
