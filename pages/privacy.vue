  ...
  <div class="min-h-screen flex flex-col bg-gray-50">
    ...
    <div class="bg-navy pt-32 pb-20 relative overflow-hidden">
      <div class="absolute inset-0 z-0">
        <img src="/hero-homepage.jpeg" alt="Archeris Privacy Policy" class="w-full h-full object-cover" />
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div>
          ...
          <p class="text-slate-300 text-sm md:text-lg leading-relaxed">
            At Archeris, we protect your personal and tournament data with absolute precision.
          </p>
