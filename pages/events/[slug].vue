                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <nav class="hidden md:flex items-center gap-8">
                        ...
                        <a href="/tournaments"
                            ...
                            Turnamen</a>
                        <a href="#"
                            class="text-gray-600 hover:text-navy font-medium text-sm transition-colors">Peringkat</a>
                        <a href="#"
                            class="text-gray-600 hover:text-navy font-medium text-sm transition-colors">Berita</a>
                    </nav>
                    <div class="flex items-center gap-4">
                        <a href="/auth/login"
                            class="hidden md:flex text-gray-600 font-medium text-sm hover:text-navy">Masuk</a>
