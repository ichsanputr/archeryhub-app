        ...
        <table v-else class="w-full">
          ...
          <tbody class="divide-y divide-[#4a4421]">
            <tr 
              ...
              :key="acc.id"
              class="hover:bg-[#4a4421]/20 group"
            >
              <td class="px-6 py-4">
              ...
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  <div class="w-10 h-10 rounded-full bg-[#4a4421] flex items-center justify-center text-[#ccc38e] font-bold text-sm">
              ...
              <td class="px-6 py-4">
                <span 
                  ...
                  :class="getCardTypeClass(acc.card_type)"
                >
                  {{ acc.card_type }}
                </span>
              </td>
              <td class="px-6 py-4">
                <span 
                  class="px-2.5 py-1 rounded-full text-xs font-medium"
                  :class="getStatusClass(acc.status)"
                >
                  {{ acc.status }}
                </span>
              </td>
              <td class="px-6 py-4 text-right">
                <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  <button 
                    v-if="acc.status === 'printed'"
                    @click="updateStatus(acc.id, 'issued')"
                  ...
                  <button 
                    ...
                    @click="updateStatus(acc.id, 'revoked')"
                    class="p-2 rounded-lg bg-red-600/50 text-red-300 hover:bg-red-600 transition-colors"
                    title="Revoke"
                  >
        ...
        <div class="bg-[#2E2B1B] rounded-2xl w-full max-w-2xl border border-[#4a4421]">
          ...
          <div class="p-6">
            ...
            <div v-else class="space-y-4">
              <div 
                v-for="gate in gateSituation" 
                :key="gate.gate_name"
                class="bg-[#4a4421]/30 rounded-xl p-4"
              >
        ...
        <div class="bg-[#2E2B1B] rounded-2xl w-full max-w-md border border-[#4a4421]">
          ...
          <form @submit.prevent="bulkCreate" class="p-6 space-y-4">
            ...
            <div>
              ...
              <input 
                v-model="bulkForm.accessAreas"
                type="text"
                placeholder="e.g., FOH, Warm-up, Media"
                class="w-full bg-[#23200f] border border-[#4a4421] rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-[#f9d406]/50"
              />
            </div>
