            ...
            <div v-else class="space-y-3">
              ...
              >
                <div class="flex items-center">
                  <Icon :ssr="true"
                    :icon="activity.type === 'solved' ? 'ph:check-circle' : 'ph:x-circle'"
                    :class="[
                      'w-5 h-5 mr-3',
            ...
            <div class="bg-gray-50 rounded-lg p-4">
              ...
              <div class="space-y-3">
                <label class="flex items-center">
                  <input v-model="settings.emailNotifications" type="checkbox" class="rounded border-gray-300 text-yellow-600 focus:ring-yellow-500" />
                  <span class="ml-2 text-sm text-gray-700">Email notifications</span>
                </label>
                <label class="flex items-center">
                  <input v-model="settings.publicProfile" type="checkbox" class="rounded border-gray-300 text-yellow-600 focus:ring-yellow-500" />
