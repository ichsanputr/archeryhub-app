                ...
                <div>
                    <div class="flex items-center gap-2 mb-1.5">
                        <span
                            ...
                            {{ status === 'expired' ? t('subscription.header.badge_expired') : t('subscription.header.badge_canceled') }}
                        </span>
        ...
        <div class="relative p-6 sm:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-3">
                <div v-if="status === 'trial'"
                    ...
                    <span class="text-xs font-black text-white tracking-widest">{{ t('subscription.status.trial_active') }}</span>
                </div>
                <div v-else-if="status === 'active'"
                    ...
                    <span class="text-xs font-black text-green-300 tracking-widest">{{ t('subscription.status.active') }}</span>
                </div>
            </div>
        </div>
    </div>
