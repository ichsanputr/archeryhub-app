        ...
        <div class="space-y-5">
            <div class="flex items-center gap-3">
                <div
                    ...
                    <Icon icon="ph:buildings-bold" class="text-lg" />
                </div>
                <h2 class="text-lg font-extrabold text-navy">Pilihan Paket Klub</h2>
            </div>
            <div
                ...
                <div
                    ...
                    <div class="relative z-10">
                        <span class="text-primary/60 font-black tracking-[0.3em] text-[10px] uppercase mb-4 block">
                            Direkomendasikan untuk Klub Utama
                        </span>
                        ...
                        <div class="text-slate-400 text-sm font-medium max-w-[220px] mx-auto leading-relaxed">
                            Dapatkan fitur eksklusif dan kapasitas anggota tak terbatas untuk komunitas Anda.
                        </div>
                        <div class="mt-12 space-y-4">
                            <div class="flex items-center gap-3 justify-center text-primary/80">
                                <Icon icon="ph:users-three-fill" class="text-xl" />
                                <span class="text-xs font-black uppercase tracking-widest text-white/80">Anggota Tak
                                    Terbatas</span>
                            </div>
                            <div class="flex items-center gap-3 justify-center text-primary/80">
