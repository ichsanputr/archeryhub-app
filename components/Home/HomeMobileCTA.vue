            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="order-2 lg:order-1">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="#" class="inline-flex items-center gap-3 bg-navy text-white px-8 py-4 rounded-2xl hover:scale-105 transition-transform shadow-xl">
                ...
                <div class="order-1 lg:order-2 flex justify-center lg:justify-end">
                    <div class="relative w-full max-w-[500px]">
                        <img src="/archery_mobile_app_download_1778934899178.png" alt="Archeris Mobile App" class="w-full h-auto object-contain drop-shadow-2xl" />
                    </div>
                </div>
            </div>
        </div>
