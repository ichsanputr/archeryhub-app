    ...
    <div class="bracket-round arena-column min-w-[550px]">
        ...
        <div class="round-header !flex-row !gap-4 !items-end !mb-12">
            <div class="flex flex-col items-center">
                <span class="text-[10px] font-black tracking-[0.25em] text-slate-400 capitalize">Semifinal</span>
            </div>
            <div class="h-8 w-px bg-slate-200 mb-1"></div>
            <div class="flex flex-col items-center">
                <span class="text-[10px] font-black tracking-[0.25em] text-slate-400 capitalize">Finals</span>
            </div>
        </div>
                ...
                <div class="arena-title mb-3">
                    <div class="flex flex-col items-center">
                        <div
                            ...
                            <span class="text-[11px] font-black text-amber-950 tracking-[0.25em]">Grand Final</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="bronze-match-container absolute bottom-4 inset-x-0 w-full flex flex-col items-center z-10">
                <div class="flex items-center gap-3 w-full mb-3 relative">
                    ...
                    <div
                        ...
                        <span class="text-[9px] font-black text-slate-600 tracking-[0.15em]">Bronze Match</span>
                    </div>
                    <div class="h-px flex-1 bg-slate-200"></div>
                </div>
